...
function measure() {
  ...
  ./patatrack-scripts/benchmark ${NAME}.py \
    ...
    --slot n=6:m=6:nv=GPU-3b360572-d57c-1b5c-4ee8-0b2275797f02 \
    --slot n=7:m=7:nv=GPU-3b360572-d57c-1b5c-4ee8-0b2275797f02 \
...
measure 100000 20000 reduced_hlt bergamo-reduced-hlt-2xGPUs
