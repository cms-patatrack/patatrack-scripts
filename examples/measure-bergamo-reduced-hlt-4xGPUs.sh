...
function measure() {
  ...
  ./patatrack-scripts/benchmark ${NAME}.py \
    ...
    --slot n=0:m=0:nv=GPU-864c87c9-5304-78aa-a88e-cf477e8dbad4 \
    --slot n=0:m=0:nv=GPU-864c87c9-5304-78aa-a88e-cf477e8dbad4 \
    --slot n=1:m=1:nv=GPU-864c87c9-5304-78aa-a88e-cf477e8dbad4 \
    --slot n=1:m=1:nv=GPU-864c87c9-5304-78aa-a88e-cf477e8dbad4 \
    --slot n=2:m=2:nv=GPU-9107ffaa-3302-0e2a-fdbe-00c02f49913d \
    --slot n=2:m=2:nv=GPU-9107ffaa-3302-0e2a-fdbe-00c02f49913d \
...
measure 100000 20000 reduced_hlt bergamo-reduced-hlt-4xGPUs
