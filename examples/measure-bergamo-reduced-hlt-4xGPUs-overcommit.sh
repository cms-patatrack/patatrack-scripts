...
function measure() {
  ...
  ./patatrack-scripts/benchmark ${NAME}.py \
    ...
    --slot n=0:m=0:nv=GPU-864c87c9-5304-78aa-a88e-cf477e8dbad4:e=220000 \
    --slot n=0:m=0:nv=GPU-864c87c9-5304-78aa-a88e-cf477e8dbad4:e=220000 \
    --slot n=1:m=1:nv=GPU-864c87c9-5304-78aa-a88e-cf477e8dbad4:e=220000 \
    --slot n=1:m=1:nv=GPU-864c87c9-5304-78aa-a88e-cf477e8dbad4:e=220000 \
    ...
    --slot n=5:m=5:nv=GPU-3b360572-d57c-1b5c-4ee8-0b2275797f02:e=220000 \
    --slot n=6:m=6:nv=GPU-e73f7ca5-0afc-092a-21ab-4cbf9a69b3b6:e=220000 \
    --slot n=6:m=6:nv=GPU-e73f7ca5-0afc-092a-21ab-4cbf9a69b3b6:e=220000 \
    --slot n=7:m=7:nv=GPU-e73f7ca5-0afc-092a-21ab-4cbf9a69b3b6:e=220000 \
    --slot n=7:m=7:nv=GPU-e73f7ca5-0afc-092a-21ab-4cbf9a69b3b6:e=220000 \
    --slot n=0:m=0:nv= \
    --slot n=0:m=0:nv= \
    --slot n=1:m=1:nv= \
...
measure 100000 20000 reduced_hlt bergamo-reduced-hlt-4xGPUs-overcommit
