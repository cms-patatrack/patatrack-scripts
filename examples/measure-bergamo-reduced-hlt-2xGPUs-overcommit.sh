...
function measure() {
  ...
  ./patatrack-scripts/benchmark ${NAME}.py \
    ...
    --slot n=0:m=0:nv=GPU-9107ffaa-3302-0e2a-fdbe-00c02f49913d:e=220000 \
    --slot n=1:m=1:nv=GPU-9107ffaa-3302-0e2a-fdbe-00c02f49913d:e=220000 \
    --slot n=2:m=2:nv=GPU-9107ffaa-3302-0e2a-fdbe-00c02f49913d:e=220000 \
    --slot n=3:m=3:nv=GPU-9107ffaa-3302-0e2a-fdbe-00c02f49913d:e=220000 \
    --slot n=4:m=4:nv=GPU-3b360572-d57c-1b5c-4ee8-0b2275797f02:e=220000 \
    --slot n=5:m=5:nv=GPU-3b360572-d57c-1b5c-4ee8-0b2275797f02:e=220000 \
    --slot n=6:m=6:nv=GPU-3b360572-d57c-1b5c-4ee8-0b2275797f02:e=220000 \
    --slot n=7:m=7:nv=GPU-3b360572-d57c-1b5c-4ee8-0b2275797f02:e=220000 \
    --slot n=0:m=0:nv= \
    --slot n=0:m=0:nv= \
    --slot n=1:m=1:nv= \
    --slot n=1:m=1:nv= \
...
measure 100000 20000 reduced_hlt bergamo-reduced-hlt-2xGPUs-overcommit
